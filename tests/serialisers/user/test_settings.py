...
def test_paymentprofileserialiser_get(
    get_account, regex_account, regex_settings, settings_keys
):
...
def test_paymentprofileserialiser_delete(get_account, regex_account, regex_settings):
