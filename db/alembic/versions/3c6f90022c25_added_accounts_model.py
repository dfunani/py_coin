...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_status",
            sa.Enum(AccountStatus, name="enum_user_account_statuses_check"),
            unique=False,
            default=AccountStatus.NEW,
        ),
        sa.Column(
            "account_email_status",
            sa.Enum(AccountEmailVerification, name="enum_user_email_statuses_check"),
            unique=False,
        ...
        sa.Column(
            "account_role",
            sa.Enum(AccountRole, name="enum_user_account_roles_check"),
            nullable=False,
