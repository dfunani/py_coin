...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_id", sa.String(256), sa.ForeignKey("users.accounts.id"), nullable=False
        ),
        sa.Column("card_id", sa.String(256), sa.ForeignKey("warehouse.cards.id"), nullable=False),
        sa.Column(
