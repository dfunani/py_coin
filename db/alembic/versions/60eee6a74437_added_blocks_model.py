...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("block_id", sa.String(256), nullable=False),
        sa.Column(
            "transaction_id",
            sa.String(256),
        ...
        sa.Column("previous_block_id", sa.ForeignKey("blockchain.blocks.id"), nullable=True),
        sa.Column("next_block_id", sa.ForeignKey("blockchain.blocks.id"), nullable=True),
        sa.Column(
            "block_type",
